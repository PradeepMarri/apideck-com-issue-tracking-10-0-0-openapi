# Issue Tracking API MCP Server

This MCP (Model Content Protocol) server provides access to Issue Tracking API API functionality through HTTP, HTTPS, and STDIO transport modes.
