...
func CollectionsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/issue-tracking/collections%s", cfg.BaseURL, queryString)
		...
		var result models.GetCollectionsResponse
...
func CreateCollectionsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections",
		mcp.WithDescription("List Collections"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionsallHandler(cfg),
	}
}
