...
func CollectionsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/issue-tracking/collections/%s%s", cfg.BaseURL, collection_id, queryString)
		...
		var result models.GetCollectionResponse
...
func CreateCollectionsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionsoneHandler(cfg),
	}
}
