...
func CollectionticketcommentsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetCommentResponse
...
func CreateCollectionticketcommentsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id_tickets_ticket_id_comments_id",
		mcp.WithDescription("Get Comment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketcommentsoneHandler(cfg),
	}
}
