...
func CollectionticketcommentsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/issue-tracking/collections/%s/tickets/%s/comments/%s%s", cfg.BaseURL, id, collection_id, ticket_id, queryString)
		...
		var result models.UpdateCommentResponse
...
func CreateCollectionticketcommentsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_issue-tracking_collections_collection_id_tickets_ticket_id_comments_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketcommentsupdateHandler(cfg),
	}
}
