...
func CollectionticketcommentsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteCommentResponse
...
func CreateCollectionticketcommentsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_issue-tracking_collections_collection_id_tickets_ticket_id_comments_id",
		mcp.WithDescription("Delete Comment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketcommentsdeleteHandler(cfg),
	}
}
