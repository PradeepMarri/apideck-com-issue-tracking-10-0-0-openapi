...
func CollectionticketcommentsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetCommentsResponse
...
func CreateCollectionticketcommentsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id_tickets_ticket_id_comments",
		mcp.WithDescription("List Comments"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketcommentsallHandler(cfg),
	}
}
