...
func CollectionusersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/issue-tracking/collections/%s/users/%s%s", cfg.BaseURL, collection_id, id, queryString)
		...
		var result models.GetCollectionUserResponse
...
func CreateCollectionusersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id_users_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionusersoneHandler(cfg),
	}
}
