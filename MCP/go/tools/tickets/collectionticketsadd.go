...
func CollectionticketsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCollectionticketsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_issue-tracking_collections_collection_id_tickets",
		mcp.WithDescription("Create Ticket"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketsaddHandler(cfg),
	}
}
