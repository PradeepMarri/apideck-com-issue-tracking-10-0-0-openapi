...
func CollectionticketsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCollectionticketsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id_tickets_ticket_id",
		mcp.WithDescription("Get Ticket"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketsoneHandler(cfg),
	}
}
