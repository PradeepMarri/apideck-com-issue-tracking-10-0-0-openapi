...
func CollectionticketsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/issue-tracking/collections/%s/tickets%s", cfg.BaseURL, collection_id, queryString)
		...
		var result models.GetTicketsResponse
...
func CreateCollectionticketsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_issue-tracking_collections_collection_id_tickets",
		mcp.WithDescription("List Tickets"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CollectionticketsallHandler(cfg),
	}
}
